...
```{r}
# throughout the years, how have race statistics changed regarding police deaths?
library(dplyr)
...
ggplot(meanFGA) +
  ...
  coord_flip()
  labs(title = "Average Field Goal Attempts Per Player Per 2019-2020 League", y = "Average Field Goal Attempts")
...
ggplot(meanAST) +
  ...
  coord_flip() +
  labs(title = "Average Assists Per Player Per 2019-2020 League", y = "Average Assists")
...
ggplot(meanFGM) +
  ...
  coord_flip() +
  labs(title = "Average FGM Per Player Per 2019-2020 League", y = "Average Field Goals Made")
...
ggplot(meanHT) +
  ...
  labs(title = "Average Height Per Player Per 2019-2020 League", y = "Average Height") +
  coord_flip() +
...
sampleplayer <- player_stats %>% group_by(League) %>% filter(League %in% c("NBA", "Euroleague", "Lithuanian-LKL", "Mexican-LNBP", "Chinese-CBA", "Canadian-NBL")) %>% sample_n(40)

ggplot(sampleplayer, aes(x = height_cm, y = log(GP), color = League)) +
    geom_point() + 
  labs(title = "Games Played by Height", x = "Height (cm)", y = "Games Played") +
  geom_jitter()
